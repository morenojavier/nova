# SaaS V4 - Agent-First Software Factory
...
| 10 | `update-sf` | Actualizar SaaS a la ultima version |
| 11 | `eject-sf` | Remover SaaS del proyecto. DESTRUCTIVO. Confirmar siempre |

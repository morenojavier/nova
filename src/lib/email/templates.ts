...
<head>
  ...
  <title>Cita Confirmada - Nova</title>
...
<body>
  <div class="container">
    ...
    <div class="footer">
      <p>Este correo fue enviado autom&aacute;ticamente por Nova</p>
      <p>&copy; ${new Date().getFullYear()} Nova - Gesti&oacute;n Legal Inteligente</p>
    </div>
  </div>
</body>
</html>
...
<head>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Nueva Cita Agendada - Nova</title>
  <style>${baseStyles}</style>
</head>
<body>
  <div class="container">
...
<head>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Nueva Cita en el Sistema - Nova</title>
  <style>${baseStyles}</style>
</head>
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <p class="message">
        Se ha registrado una nueva cita en el sistema Nova.
      </p>
    ...
    <div class="footer">
      <p>Notificaci&oacute;n autom&aacute;tica del sistema Nova</p>
      <p>&copy; ${new Date().getFullYear()} Nova</p>
    </div>
  </div>
</body>
</html>
...
<head>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Cita ${config.label} - Nova</title>
  <style>${baseStyles}</style>
</head>
<body>
  <div class="container">

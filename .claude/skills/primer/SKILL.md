...
Este proyecto fue creado con **SaaS**, una template optimizada para desarrollo Agent-First. Al ejecutar este skill, el agente entiende inmediatamente que tiene disponible y como trabajar.
...
- `eject-sf` - Eliminar configuracion SaaS

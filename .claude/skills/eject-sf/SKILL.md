---
name: eject-sf
description: "DESTRUCTIVO: Eliminar SaaS del proyecto y dejar solo el software funcional. Activar cuando el usuario dice: quiero quitar SaaS, eject, remover el template, limpiar el proyecto, o distribuir el codigo sin la fabrica. SIEMPRE confirmar antes de ejecutar."
...
- Referencias a "SaaS" en el codigo
...
Modifica estos archivos para quitar referencias a SaaS:

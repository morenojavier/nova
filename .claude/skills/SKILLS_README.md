...
| `eject-sf` | `/eject-sf` | Remover SaaS del proyecto (DESTRUCTIVO) |
...
SaaS incluye un sistema de memoria persistente POR PROYECTO que reemplaza la auto-memory de Claude Code.

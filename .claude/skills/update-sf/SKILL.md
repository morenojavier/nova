---
name: update-sf
description: "Actualizar SaaS a la ultima version. Activar cuando el usuario dice: actualiza el template, hay nueva version, update SaaS, quiero la ultima version, o cuando se detecta que el template esta desactualizado."
...
> No encontre el alias `saas-factory`. Por favor, indica la ruta donde tienes el repositorio de SaaS.
...
```
SaaS actualizado correctamente.
